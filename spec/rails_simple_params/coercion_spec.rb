...
describe RailsSimpleParams::Coercion do
  describe '.new' do
    let(:param) { 'foo' }
    let(:type) { String }
    ...
    let(:coercion_class) { RailsSimpleParams::Coercion::StringParam }
  ...
  describe '#coerce' do
    ...
    let(:coercion_class) { RailsSimpleParams::Coercion::IntegerParam }
